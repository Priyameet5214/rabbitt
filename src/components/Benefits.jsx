    ...
    <Section id="features">
      <div className="container relative z-2">
        {/* <Heading
          ...
          title="Build smarter AI solutions for your brand with Rabbitt"
        /> */}
        ...
        <div className="flex flex-wrap gap-10 mb-10">
          {benefits.map((item) => (
            <motion.div // Wrap each benefit item in motion.div
            ...
            >
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                ...
                <motion.p
                  ...
                  whileHover={{ color: "#333" }} // Example of hover animation
                >
                  {item.text}
                </motion.p>
